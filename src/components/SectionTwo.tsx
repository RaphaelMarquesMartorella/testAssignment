...
export default function SectionTwo() {
    return (
        <main className="bg-[#FAFAFA] px-4 sm:px-0 md:px-8 lg:px-16 xl:px-32 flex flex-col sm:flex-row mt-5 sm:mt-10 mb-5 sm:mb-10 sm:ml-[80px] sm:mr-[80px]">
            ...
            <div className="right-side p-4 sm:p-6 md:p-8 lg:p-10">
                ...
                <ul className="mt-4 sm:mt-6 md:mt-8 lg:mt-10">
                    <li className="flex items-center">
                        <Image
                            ...
                            alt="tick-circle"
                        />
                        <p className="ml-2 sm:ml-4 md:ml-6 lg:ml-8 text-manrope text-sm sm:text-[15px] lg:text-lg font-normal">Negative Ion Technology may <span className="font-bold text-[#2C7EF8]"> help with allergens</span></p>
                    </li>
                    <li className="flex items-center mt-2 sm:mt-3 md:mt-4 lg:mt-5">
                        <Image
                            ...
                            alt="tick-circle"
                        />
                        <p className="ml-2 sm:ml-4 md:ml-6 lg:ml-8 text-manrope text-sm sm:text-[15px] lg:text-lg font-normal">Designed for<span className="font-bold"> air rejuvenation</span></p>
                    </li>
                    <li className="flex items-center mt-2 sm:mt-3 md:mt-4 lg:mt-5">
                        <Image
                            src='/tick-circle.png'
                            ...
                            alt="tick-circle"
                        />
                        <p className="ml-2 sm:ml-4 md:ml-6 lg:ml-8 text-manrope text-sm sm:text-[15px] lg:text-lg font-normal"><span className="font-bold">Perfect for every room </span>in all types of places.</p>
                    </li>
                </ul>
                <div className="coupon-area bg-[#EDF3FD] mt-4 sm:mt-6 md:mt-8 lg:mt-10 rounded-2xl flex">
                    <Image
                        ...
                        className="m-2"
                    />
                    <p className="mt-2 text-manrope font-normal w-[100%] text-sm sm:text-base lg:text-[17px] md:text-[13px] sm:text-[10px]">Save <span className="text-[#2C7EF8]">53%</span> and get <span className="text-[#2C7EF8]">6 extra Clarifision</span> for only <span className="text-[#2C7EF8]">$14 Each</span></p>
                </div>
                <div className="buy-area mt-4 sm:mt-6 md:mt-8 lg:mt-10">
                    ...
                    <Image
                        ...
                        className="mt-4 sm:mt-6 md:mt-8 lg:mt-10"
                    />
                    <h2 className="text-[#F82C2C] text-center text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mt-4 sm:mt-6 md:mt-8 lg:mt-10 underline text-manrope font-normal cursor-pointer">No thanks, I don’t want this.</h2>
                </div>
                <div className="guarantee-area flex mt-4 sm:mt-6 md:mt-8 lg:mt-10">
                    <Image
                        ...
                        alt="stamp"
                    />
                    <p className="text-manrope font-light ml-2 sm:ml-4 md:ml-6 lg:ml-8 text-sm sm:text-base">If you are not completely thrilled with your Clarifion - We<br/> have a <span className="text-manrope font-semibold">30 day satisfaction guarantee.</span> Please refer to our<br/> return policy at the bottom of the page for more details.<br/> Happy Shopping!</p>
                </div>
            </div>
        </main>
    );
